...
- Highly Available, Multi AZ by default, Read, and Writes are decoupled, with transaction capability
- DAX cluster for read cache, microsecond read latency
- Security, authentication and authorisation are done through IAM
...
- Use cases:
  ...
  - Maintain your graph data synchronised in another data store (e.g., S3, OpenSearch, ElastiCache)
...
- Built-in time series analytics functions (help you identify patterns in your data in near real-time)
...
![[Pasted image 20260130144456.png]]
