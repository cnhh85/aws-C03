...
![[Pasted image 20260203004544.png]]
...
- The encryption/decryption keys must be managed somewhere, and the server must have access to them

![[Pasted image 20260203004623.png]]
...
![[Pasted image 20260203004641.png]]
...
- An easy way to control access to your data
...
- **Symmetric (AES-256 keys)**
  ...
  - You never get access to the KMS Key unencrypted (must call the KMS API to use)
...
![[Pasted image 20260203004821.png]]
...
![[Pasted image 20260203004915.png]]

### KMS Multi-Region Keys

![[Pasted image 20260203004931.png]]
...
![[Pasted image 20260203005036.png]]
...
![[Pasted image 20260203005137.png]]
...
1. AMI in Source Account is encrypted with the KMS Key from Source Account
...
4. The IAM Role/User in the target account must have the permissions to DescribeKey, ReEncrypt*, CreateGrant, and Decrypt
...
![[Pasted image 20260203005324.png | 500]]
...
![[Pasted image 20260203005354.png|500]]
...
![[Pasted image 20260203005653.png]]
...
![[Pasted image 20260203005738.png]]
...
![[Pasted image 20260203005815.png | 500]]
...
2. Select Validation Method: DNS Validation or Email validation
    ...
    - DNS Validation will leverage a CNAME record to the DNS config (ex, Route 53)
...
![[Pasted image 20260203010033.png]]

### ACM – Integration with ALB

![[Pasted image 20260203010045.png]]
...
- **Edge-Optimized** **(default)**: For global clients
  - Requests are routed through the CloudFront Edge locations (improves latency)
  - The API Gateway still lives in only one region
  - **The TLS Certificate must be in the same region as CloudFront, in us-east-1** #trap
  - Then setup CNAME or (better) A-Alias record in Route 53
- **Regional**:
  - For clients within the same region
  - **The TLS Certificate must be imported on the API Gateway, in the same region as the API Stage** #trap
  - Then setup CNAME or (better) A-Alias record in Route 53

![[Pasted image 20260203010311.png | 500]]
...
- Define Web ACL (Web Access Control List) Rules:
  ...
  - HTTP headers, HTTP body, or URI strings protect from common attacks - **SQL injection** and **Cross-Site Scripting (XSS)**
...
![[Pasted image 20260203010534.png]]
...
- If you want to use AWS WAF across accounts, accelerate WAF configuration, automate the protection of new resources, and use Firewall Manager with AWS WAF
...
![[Pasted image 20260203010828.png]]

### Best practices for DDoS mitigation

- Infrastructure layer defense (BP1, BP3, BP6)
  - Protect Amazon EC2 against high traffic
  - That includes using Global Accelerator, Route 53, CloudFront, and Elastic Load Balancing
...
- Obfuscating AWS resources (BP1, BP4, BP6)
  - Using CloudFront, API Gateway, and Elastic Load Balancing to hide your backend resources (Lambda functions, EC2 instances)
- Security groups and Network ACLs (BP5)
  - Use security groups and NACLs to filter traffic based on specific IP addresses at the subnet or ENI-level
...
![[Pasted image 20260203011241.png]]
...
![[Pasted image 20260203011424.png]]
