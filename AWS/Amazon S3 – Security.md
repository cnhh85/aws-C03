...
- **SSE-S3 encryption is automatically applied to new objects stored in the S3 bucket**
...
- **Retention Period:** protect the object for a fixed period, which can be extended
- **Legal Hold:**
